package org.bguerra.anotaciones.ejemplo.procesador;

import org.bguerra.anotaciones.ejemplo.Init;
import org.bguerra.anotaciones.ejemplo.JsonAtributo;
import org.bguerra.anotaciones.ejemplo.procesador.exception.JsonSerializadorException;
        ...
        Arrays.stream(metodos).filter(m -> m.isAnnotationPresent(Init.class))
                .forEach(m -> {
                    ...
                    try {
                        ...
                        throw new JsonSerializadorException("El objeto a serializar, no se puede iniciar el objeto"
                                + e.getMessage());
                    }
                });
    }
                    ...
                    try {
                        ...
                        if (f.getAnnotation(JsonAtributo.class).capitalizar() &&
                           ...
                           /* nuevoValor = String.valueOf(nuevoValor.charAt(0)).toUpperCase()
                                    + nuevoValor.substring(1).toUpperCase();*/
